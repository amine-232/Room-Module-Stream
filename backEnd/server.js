...
const webrtc = require("wrtc"); // Ensure you have 'wrtc' package installed please check the new version with update code no need for wbrtc using peer to peer connection
